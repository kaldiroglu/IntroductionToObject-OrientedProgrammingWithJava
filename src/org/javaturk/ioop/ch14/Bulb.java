 ...
 * To better understand check Internet as to how a bulb works!
 *
 *
 * @author Akin Kaldiroglu
 * @version 1.3.7
 * @see <a href="http://www.javaturk.org">JavaTurk.org</a>
 * @see <a href="http://en.wikipedia.org/wiki/Bulb">If you are interested in Bulb in botany</a>
 * @since 1.2
 */
public class Bulb {
     ...
     * @throws IllegalArgumentException in case of passing non-positive
     *                                  argument.
     */
    ...
    /**
     * Turns on the bulb. Current luminescence is set to max luminescence.
     */
    public void on() {
